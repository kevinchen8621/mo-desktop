...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $stateProvider
        ...
        .state('dashboards', { url: "/dashboards", templateUrl: "views/common/content.html", abstract: true })
        .state('dashboards.wemedia', { url: "/wemedia", templateUrl: "views/wemedia.html",})
        .state('dashboards.dashboard_1', { url: "/dashboard_1", templateUrl: "views/dashboard_1.html", })
        .state('dashboards.dashboard_2', { url: "/dashboard_2", templateUrl: "views/dashboard_2.html", data: { pageTitle: 'Dashboard 2' }, })
        .state('dashboards.dashboard_3', { url: "/dashboard_3", templateUrl: "views/dashboard_3.html", data: { pageTitle: 'Dashboard 3' }, })
        ...
        .state('dashboards.dashboard_4_1', { url: "/dashboard_4_1", templateUrl: "views/dashboard_4_1.html", data: { pageTitle: 'Dashboard 4' }, })
        .state('dashboards.dashboard_5', { url: "/dashboard_5", templateUrl: "views/dashboard_5.html", data: { pageTitle: 'Dashboard 5' }, })
        .state('blogs', { url: "/blogs", templateUrl: "views/common/content.html", abstract: true })
        .state('blogs.list', { url: "/list", templateUrl: "views/blogs/list.html",})
        .state('blogs.compose', { url: "/compose", templateUrl: "views/blogs/compose.html",})
        .state('blogs.detail', { url: "/detail", templateUrl: "views/blogs/detail.html",})
        .state('blogs.template', { url: "/template", templateUrl: "views/blogs/template.html",})
        .state('blogs.accounts', { url: "/accounts", templateUrl: "views/blogs/accounts.html",})
        .state('weixin', { url: "/weixin", templateUrl: "views/common/content.html", abstract: true })
        .state('weixin.wemedia', { url: "/wemedia", templateUrl: "views/wemedia.html",})

        .state('layouts', { url: "/layouts", templateUrl: "views/layouts.html", data: { pageTitle: 'Layouts' }, })
        .state('charts', {
            abstract: true,
            url: "/charts",
